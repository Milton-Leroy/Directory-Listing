                ...
                <div class="col-lg-9">
                    <div class="dashboard_content">
                        <div class="my_listing">
                            <a href="{{ route('user.listing.index') }}" class="read_btn"><i class="fas fa-chevron-left"></i></a>
                            <h4>Image Gallery ({{  $listingTitle->title }})</h4>
                            <form action="{{ route('user.listing-image-gallery.store') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label class="mb-2" for="">Image <code>(Multi images supported)</code></label>
                                ...
                                <tbody>
                                    @foreach ($images as $image)
                                        <tr>
                                            ...
                                            <td>
                                                <img style="width: 100px !important;" src="{{ asset($image->image) }}" alt="image of">
                                            </td>
                                            <td>
