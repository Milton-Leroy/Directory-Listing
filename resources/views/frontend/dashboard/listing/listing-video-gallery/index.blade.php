                ...
                <div class="col-lg-9">
                    <div class="dashboard_content">
                        <div class="my_listing">
                            <a href="{{ route('user.listing.index') }}" class="btn btn-primary"><i
                                    class="fas fa-chevron-left"></i></a>
                            <h4>Video Gallery ({{ $listingTitle->title }})</h4>

                            <form action="{{ route('user.listing-video-gallery.store') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label class="mb-2" for="">Youtube Video Url<code> *</code></label>
                                ...
                                <tbody>
                                    @foreach ($videos as $video)
                                        <tr>
                                            ...
                                            <td>
                                                <img style="width: 200px !important" src="{{ getYtThumbnail($video->video_url) }}" alt="image of">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('user.listing-video-gallery.destroy', $video->id) }}"
