...
@section('contents')
    ...
    <div id="breadcrumb_part"
        style="
         background: url({{ asset(@$listing->thumbnail_image) }});
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="listing_det_side_address">
                                    ...
                                    @if ($listing->website)
                                        <a href="{{ $listing->website }}" target="__blank"><i
                                                class="fal fa-globe"></i>{{ $listing->website }}</a>
                                    @endif
                                    <ul>
                                        ...
                                        @if ($listing->instagram_link)
                                            <li><a href="{{ $listing->instagram_link }}"><i
                                ...
                                <div class="col-12">
                                    <div class="listing_det_side_list">
                                        ...
                                        @foreach ($similarListings as $similarListing)
                                            <a href="{{ route('user.listing.show', $similarListing->slug) }}"
