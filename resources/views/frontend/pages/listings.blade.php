                        ...
                        @foreach ($listings as $listing)
                            <div class="col-xl-4 col-sm-6">
                                <div class="wsus__featured_single">
                                    ...
                                    <a class="map" onclick="showListingAlert('{{ $listing->id }}')" data-bs-toggle="modal" data-bs-target="#exampleModal2"
                                    ...
                                    <div class="wsus__featured_single_text">
                                        ...
                                        <a href="{{ route('listing.show',$listing->slug) }}">{{ truncate($listing->title,23) }}</a>
